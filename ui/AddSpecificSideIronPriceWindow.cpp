...
AddSpecificSideIronPriceWindow::AddSpecificSideIronPriceWindow(Client* client, SideIron* sideIron, ComponentInsert::PriceMode priceMode, QWidget* parent)
	: QDialog(parent), ui(new Ui::AddSpecificSideIronPriceWindow) { //update | remove
	ui->setupUi(this);
	...
	sideIronComboBox->setCurrentIndex(sideIronComboBox->findData(sideIron->handle()));
